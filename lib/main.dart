...
import 'package:yudvatar/ui/camera_page.dart';
import 'package:yudvatar/ui/gallery_page.dart';
import 'package:yudvatar/ui/video/playlist_page.dart';

Future<void> main() async {
  WidgetsFlutterBinding.ensureInitialized(); // <-- important

  runApp(MaterialApp(home: const PlaylistPage()));
}
...
class _BottomNavigationBarExampleState
  ...
  initPages() async {
    _widgetOptions = [const PlaylistPage()];
